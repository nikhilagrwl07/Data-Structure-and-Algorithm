...
package sequencesof0123withoutadjacent;
...
//            System.out.println("Sequences :: " + Sequence2(n1, n2, n3, n4, "");
                    ...
                    for (int k = 0; k <= n3; k++)
                    {
                        ...
                        {                             
                            if (i + j + k + l > 1)
                            {
                                ...
                                if (k > 0) 
                                    dp3[i][j][k][l] = (dp2[i ][j][k-1][l] + dp3[i ][j][k-1][l] + dp4[i][j][k-1][l]) % MOD;
                                    dp3[i, j, k, l] = dp2[i, j, k - 1, l] + dp1[i, j, k - 1, l] + dp4[i, j, k - 1, l] % MOD;
                                if (l > 0) 
                                    dp4[i, j, k, l] = dp2[i, j, k, l - 1] + dp3[i, j, k, l - 1] + dp1[i, j, k, l - 1] % MOD;
                            }
                        }
                    }
