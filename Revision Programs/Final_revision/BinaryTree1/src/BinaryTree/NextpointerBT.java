...
//       
//       Node n2= new Node(2,n3,n4,null);
//       
//     //  Node n5= new Node(5,n6,n7,null);
//       
...
////       System.out.println("Preorder Successor of "+n+" = "+Presuccessor.value);
////     else
...
//    }
//    
//public int isBalancedInSameRecursion(Node root)
//{
//    MaxLengthSoFar ob=new MaxLengthSoFar();
//    
//    getHeightInSameRecursion(root,ob);
//    return ob.getMaxLength();    
//}
//
//private int getHeightInSameRecursion(Node root,MaxLengthSoFar dataTracker)
//{ 
//    if(root==null)
//        return 1;
...
//    
//    
//    int hieghtLch=getHeightInSameRecursion(root.left,dataTracker); 
//    int heightRch=getHeightInSameRecursion(root.right,dataTracker);
//
//
//    if(Math.abs(hieghtLch-heightRch)>1)
//        return 0;
//    
//    dataTracker.setMaxLength(1);
...
//
//
//       static HashMap<Node, Integer> htMap = new HashMap<Node, Integer>();
//        
//    
...
//    
//    
//    public static int htCal(Node a)
//    {
//        if(htMap.get(a)==null){ // not present in hashmap
//        
//            if(a==null) return 0;
//            
...
//           
//             
//            int height = 1+ Math.max(htCal(a.left),htCal(a.right));
//            htMap.put(a, height);
//            
//            return height;
//        }
...
//    if(r==null) return -1;
//    
//    return Math.max(findMax(r.left), Math.max(r.value, findMax(r.left)));
//    
//}
//
//
